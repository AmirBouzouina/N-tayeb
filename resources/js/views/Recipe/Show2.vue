	...
	<div class="recipe__show wow bounceInUp" >
            ...
            <div class="col-12 ">
                ...
                <div class="recipe-info">
                    ...
                    <div class="col-md-4 col-sm-12 text-center">
                        <p> <svg viewBox="0 0 512 512" width="2vw" height="2vh" :class="[recipe.slug]" ><g id="Out_line" data-name="Out line"> <path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978
		...
		<path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341
			...
			S375.275,472.341,256,472.341z"/>
                             ...
                             Préparation : <time datetime="<?php echo $pt; ?>" itemprop="prepTime" >{{recipe.prep}}</time>Minutes </p>
